package com.application.agenda.views.funcionarios;
...
@Route(value = "funcionarios/:pessoaID?/:action?(edit)", layout = MainLayout.class)
@PermitAll
@Uses(Icon.class)
public class FuncionariosView extends Div implements BeforeEnterObserver {

    private final String PESSOA_ID = "pessoaID";
    private final String PESSOA_EDIT_ROUTE_TEMPLATE = "funcionarios/%s/edit";
    ...
    @Autowired
    public FuncionariosView(PessoaService pessoaService) {
